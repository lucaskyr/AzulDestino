    ...
    <header className=' shadow-md  '>
        <div className='flex  justify-between  max-w-7xl  mx-auto px-8 py-4 '>
            <div className='flex items-center  '>
                <img className='h-12 ' src='./assets/azulDestino.png' alt="" />
                <h1 className='text-sky-700 font-bold text-2xl'>AzulDestino</h1>
            </div>
            <div className='flex items-center border border-sky-600 rounded-3xl shadow-md shadow-sky-200 px-4 py-1'>
            ...
            <div className='flex items-center border border-sky-600 rounded-3xl shadow-md shadow-sky-200 px-4 py-1 gap-2'>
                ...
                <p className='font-semibold'>lucas oliveira</p>
